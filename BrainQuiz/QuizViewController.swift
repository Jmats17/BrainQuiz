...
class QuizViewController : UIViewController, UITextFieldDelegate {
    ...
    func pauseAndDoStuff() {
        ...
        dispatch_after(time, dispatch_get_main_queue()) {
           ...
           // self.newDict[key] = value
            self.vocabDict.removeValueForKey(key)
            if self.vocabDict.isEmpty == true {
    ...
    func playCorrectSound() {
        ...
        sound = try! AVAudioPlayer(contentsOfURL: soundURL)
        sound.play()
    ...
    func playIncorrectSound() {
        let soundURL: NSURL = NSBundle.mainBundle().URLForResource("wrong", withExtension: "m4a")!
        sound = try! AVAudioPlayer(contentsOfURL: soundURL)
        sound.play()
